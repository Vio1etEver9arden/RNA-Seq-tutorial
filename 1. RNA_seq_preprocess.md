...
**If your computer is not powerful enough, consider using [Galaxy](https://usegalaxy.org/), a web-based platform for bioinformatics, for the upstream analysis. I attach a [Galaxy tutorial](./Papers/RNA-Seq%20Data%20Analysis%20in%20Galaxy.pdf) [(web version)](https://link.springer.com/protocol/10.1007/978-1-0716-1307-8_20) in the repository. It is enough for you to get count matrix.**
